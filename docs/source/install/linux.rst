...
本ソフトウェアのインストールには、インストーラーを使用します。インストーラーは本体の「Advance/NanoLabo」と、オープンソースの計算エンジン等を含む「Advance/NanoLabo Tool」の2つに分かれています。それぞれ以下のリンクからダウンロードしてください。
 ...
 `Advance/NanoLabo (ver.1.3) <https://github.com/advancesoftcorp/nanolabo-doc/releases/download/v1.3/install_nanolabo_linux_v1.3.bin>`_

 `Advance/NanoLabo Tool (ver.1.3) <https://github.com/advancesoftcorp/nanolabo-doc/releases/download/v1.3/install_nanolabo_tool_linux_v1.3.bin>`_
