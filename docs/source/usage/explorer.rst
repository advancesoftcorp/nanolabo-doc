...
.. table::
   ...
   | .mol, .sdf                                | MDL Molfile                                                   |                                                            |
   +-------------------------------------------+---------------------------------------------------------------+------------------------------------------------------------+
   | sannp.metro                               | `Advance/NeuralMD メトロポリス法設定ファイル <metro_link_>`_  |                                                            |
   +-------------------------------------------+---------------------------------------------------------------+------------------------------------------------------------+
...
.. _metro_link: https://neuralmd-doc.readthedocs.io/ja/latest/usage/metro.html
.. _metro_link_en: https://neuralmd-doc.readthedocs.io/en/latest/usage/metro.html
